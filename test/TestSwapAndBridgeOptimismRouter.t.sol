...
contract TestSwapAndBridgeOptimismRouter is Deployers {
    ...
    uint256 sepoliaForkId = vm.createFork(vm.rpcUrl("sepolia"));
    ...
    function setUp() public {
        ...
        poolSwapAndBridgeOptimism = new SwapAndBridgeOptimismRouter(poolManager, l1StandardBridge);
        ...
        (key,) =
            initPool(ethCurrency, Currency.wrap(address(OUTbL1Token)), IHooks(address(0)), 3000, 60, SQRT_PRICE_1_1);
